...
# Provide a proxy object so imports don't fail before init_db is called
db = _DBProxy()
...
def init_db():
    """Initialize Firebase Admin SDK and fetch the Firestore client."""
    ...
    # Pre-warm the Firestore client cache if possible
